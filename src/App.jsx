      ...
      <AuthProvider>
        <Router>
          <Routes>
            ...
            {/* عرض واجهة الطالب (التي تحتوي على زر ملف الإنجاز) - عامة */}
            <Route
            ...
            {/* 1. صفحة الطالب (لرفع الملفات) - عامة بدون تسجيل دخول */}
            <Route 
            ...
            <Route 
              ...
              element={<ProtectedRoute><SectionPortfoliosViewer /></ProtectedRoute>} 
            />
