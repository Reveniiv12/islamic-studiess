...
const GradeModal = ({
    ...
    return (
        <div className="mb-4 md:mb-8 p-4 md:p-6 rounded-xl bg-gray-800 shadow-lg max-w-full md:max-w-lg mx-auto border border-gray-700">
            ...
            <input type="text" placeholder="رقم التواصل" value={studentData.phone || ''} onChange={(e) => setStudentData({ ...studentData, phone: e.target.value })} className="w-full mb-3 p-3 border border-gray-600 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500 text-right text-sm" />
