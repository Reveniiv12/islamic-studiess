  ...
  return (
    <CustomModal title="لوحة تحكم صفحة الطالب" onClose={onClose}>
      ...
      >
        ...
        {/* 3. قسم إعدادات الأزرار الإضافية */}
        <div className="bg-gray-700/30 p-4 rounded-xl border border-gray-600/50">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              {/* زر المحادثة */}
              <div 
                 onClick={() => toggleFeature('show_chat_button')}
                 className={`p-3 rounded-lg border cursor-pointer transition-all flex items-center justify-between ${config.show_chat_button ? 'bg-indigo-900/30 border-indigo-500/50' : 'bg-gray-800 border-gray-700'}`}
              >
                  <div className="flex items-center gap-2 text-white">
                      <FaCommentDots className="text-indigo-400"/>
